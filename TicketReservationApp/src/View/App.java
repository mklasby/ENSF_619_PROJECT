...
public class App {
    public static void main(String[] args) {
        ...
        ShowTimeViewController showTimeViewController = new ShowTimeViewController(showTimeView, seatViewController,
                guiController);

        TheatreView theatreView = new TheatreView(gui, "theatrePanel");
        TheatreViewController theatreViewController = new TheatreViewController(theatreView, showTimeViewController,
                guiController);
